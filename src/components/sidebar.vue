    ...
    <nav class="navbar navbar-vertical fixed-start navbar-expand-md navbar-light" id="sidebar">
        <div class="container-fluid">
                ...
                <div class="dropdown">
                    ...
                    <a href="#" id="sidebarIcon" class="dropdown-toggle" role="button" data-bs-toggle="dropdown"
                        ...
                        <div class="avatar avatar-sm avatar-online">
                            <img src="/assets/img/avatar-1.jpg" class="avatar-img rounded-circle"
                                style="-webkit-mask-image: none;" alt="...">
                        </div>
                    </a>
            ...
            <div class="collapse navbar-collapse" id="sidebarCollapse">
                ...
                <h6 class="navbar-heading">Control Producto</h6>
                <ul class="navbar-nav mb-md-4">
                    ...
                    <li class="nav-item">
                        <router-link to="/ingreso/create" class="nav-link" active-class="active">
                            <i class="fe fe-folder"></i>Ingresos
                        </router-link>
                    </li>
                </ul>
